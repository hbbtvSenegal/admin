...
//$_SESSION['code']=$code;
    ...
    $req=$bdd->prepare("SELECT * FROM admin  where id=:log");
    $req->execute(array("log"=>$_SESSION['id']));
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Profil de l'urilisateur</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="modif_profil.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label>Login</label>
                                            <input type="text" name="login" value="<?php echo $login;?>"  class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="date_naiss" value="<?php echo $date_naiss;?>"  class="form-control" required>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Lieu de naissance</label>
                                            <input type="text" name="lieu" value="<?php echo $lieu;?>"  class="form-control" required>
                                        </div>
