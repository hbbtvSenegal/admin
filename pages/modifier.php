                        ...
                        <li>
                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="ajout.html"><i class="fa fa-edit fa-fw"></i>Ajouter</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="col-lg-12">
                ...
                <form action="modif.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label>Vidéo</label>
                                            <input type="text" name="video" value="<?php echo $video;?>"  class="form-control" required>
                                        </div>
                                        ...
                                        <a href="liste.php"><button class="btn btn-outline btn-warning"> Initialiser   </button></a>
                                        </div>                                     
                </form>
